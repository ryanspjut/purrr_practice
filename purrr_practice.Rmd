...
When your data is a single column and your function takes a column of data to return a single value, you get a single value per column.  Importantly, this operation takes a dataframe as input (a column of a dataframe) and the output is a list.  So far we have only worked with a single column.  Note that the list only has a single value.  Also notice that the name of the list element is the column name.
